...
test.beforeAll( async ({browser}) => {
    ...
    await page.locator('#userPassword').fill(userpw);
    await page.locator('#login').click();
    await page.waitForLoadState('networkidle'); //All service calls are complete    
    await context.storageState({path : "state.json"}) // Creates all the session state data
...
test('Web API with Context Injection', async () => {
